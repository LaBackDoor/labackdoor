                ...
                {projects.map((project, index) => (
                    ...
                    >
                        <a
                            ...
                            className={`relative project-link inline-block text-[7vw] leading-[0.9] font-black uppercase tracking-tighter transition-transform duration-[1500ms] ease-out font-druk
                        ...
                        >
                            <span className="relative">
                                ...
                                <span className="absolute top-[0em] transition-none will-change-transform border border-dotted left-[-0.3em] w-[2px] h-[0.85em] bg-current rotate-[25deg]" />
                            </span>
                        </a>
                    </li>
                ))}
